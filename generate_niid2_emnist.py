...
train_path = './data/train/emnist_niid2_train.json'
test_path = './data/test/emnist_niid2_test.json'
...
cifa_data = []
for i in trange(10):
    idx = cifa_data_label==(i+1)
    cifa_data.append(cifa_data_image[idx]) #cifa_data里是0-9，实际上是1-10
